...
public class LogController {
    ...
    @GetMapping
    @ApiOperation("日志查询")
    public Object query(LogQueryCriteria criteria, Pageable pageable){
        criteria.setLogType("INFO");
   ...
   /* @GetMapping(value = "/error")
    ...
    @GetMapping(value = "/error")
    @ApiOperation("错误日志查询")
    public Object queryErrorLog(LogQueryCriteria criteria, Pageable pageable){
        criteria.setLogType("ERROR");
        return logService.queryAll(criteria,pageable);
    }
    ...
    @GetMapping(value = "/error/{id}")
    @ApiOperation("日志异常详情查询")
    public Object queryErrorLogs(@PathVariable Long id){
