...
public class JobController {
    ...
    @GetMapping
    @PreAuthorize("@el.check('job:list','user:list')")
    public Object query(JobQueryCriteria criteria, Pageable pageable){
    ...
    @PostMapping
    @PreAuthorize("@el.check('job:add')")
    public JobDto create(@Validated @RequestBody Job resources){
        if (resources.getId() != null) {
            throw new BadRequestException("A new "+ ENTITY_NAME +" cannot already have an ID");
        }
        return jobService.create(resources);
    }
    ...
    @PutMapping
    @PreAuthorize("@el.check('job:edit')")
    public void update(@Validated(Job.Update.class) @RequestBody Job resources){
        jobService.update(resources);
    }
