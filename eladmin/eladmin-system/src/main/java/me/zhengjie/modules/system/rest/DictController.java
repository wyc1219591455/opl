...
public class DictController {
    ...
    @GetMapping
    @PreAuthorize("@el.check('dict:list')")
    public Object query(DictQueryCriteria resources, Pageable pageable){
   ...
   /* @Log("新增字典")
    ...
    public DictDto create(@Validated @RequestBody Dict resources){
        ...
        return dictService.create(resources);
    }
    ...
    @PutMapping
    @PreAuthorize("@el.check('dict:edit')")
    public void update(@Validated(Dict.Update.class) @RequestBody Dict resources){
        dictService.update(resources);
    }
