    ...
    <div class="app-container">
        <basic-container>
            <div class="head-container">
                <!-- 搜索 -->
                <el-input v-model="searchForm.name" clearable size="small" placeholder="请输入图纸格式名称" style="width: 200px;" class="filter-item" />
                <el-button type="primary" @click="search">搜 索</el-button>
                <el-button type="default" @click="resetSearch">重 置</el-button>
            </div>
            <addPage path="/paperAdd"></addPage>
            <div>
                <vxe-table
                    border="inner"
                    :show-overflow="false"
                ...
                >
                    ...
                    <vxe-table-column field="name" title="图纸格式名称" min-width="100"></vxe-table-column>
                    <vxe-table-column field="type" title="图纸格式" min-width="150"></vxe-table-column>
                    <vxe-table-column field="desc" title="图纸描述" min-width="120"></vxe-table-column>
            ...
            <!--弹框组件-->
            <el-dialog  title="编辑图纸格式" :visible.sync="dialogFormVisible" width="35%">
