<template>
    <el-form :model="model" :rules="rules" ref="ruleForm" label-width="100px">
        <el-form-item label="方案名称" prop="name">
            <el-input v-model.trim="model.name" style="width: 300px" placeholder="请输入方案名称"></el-input>
        </el-form-item>
        <el-form-item label="方案图标" prop="icon">
            <el-popover
        ...
        <el-form-item label="方案描述" prop="desc">
            <el-input
                    ...
                    style="width: 300px" placeholder="请输入方案描述"></el-input>
        </el-form-item>
        ...
        <el-form-item label="方案banner图" prop="banner">
            <upload
                    :action="actionUrl"
                    :avatar-type="avatar"
        ...
        methods: {
            ...
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        api.querySolution(this.model, methodType).then(()=>{
                            this.$message({
                                message,
                                type: 'success'
                            });
