    ...
    <div class="app-container">
        <basic-container>
            ...
            <el-form :inline="true" :model="searchForm" ref="searchForm"  label-width="80px">
                <el-form-item>
                    <el-input v-model.trim="searchForm.name" clearable placeholder="请输入解决方案" class="st-input-w"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <addPage path="/schemeAdd"></addPage> 
            <!--表格部分-->
            <vxe-table
                    highlight-hover-row
                    resizable
    ...
    export default {
        ...
        methods: {
            ...
            getArticleCategoryList(){
                ...
                api.querySolution(params,'get').then((res) => {
                    this.tableData = res;
                })
            },
