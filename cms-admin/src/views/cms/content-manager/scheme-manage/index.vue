    ...
    <div class="app-container">
        <basic-container>
            ...
            <el-form :inline="true" :model="searchForm" ref="searchForm"  label-width="80px">
                <el-form-item>
                    <el-input v-model.trim="searchForm.title" clearable placeholder="请输入方案名称" class="st-input-w"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <addPage path="/schemeManageAdd"></addPage> 
            <!--表格部分-->
            <vxe-table
                    resizable
                    tree-config
                ...
                <vxe-table-column field="title" title="方案名称" min-width="100"></vxe-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getArticleCategoryList(){
                ...
                api.querySolutionList(params,'get').then((res) => {
            ...
            del(val){
                ...
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    api.querySolutionList(params,'delete').then(() => {
                        this.$message({
                            type: 'success',
                            message: '删除成功!'
                        });
