    ...
    <div class="app-container">
        <basic-container>
            ...
            <el-form :inline="true" :model="searchForm" ref="searchForm"  label-width="80px">
                <el-form-item>
                    <el-input v-model.trim="searchForm.title" clearable placeholder="请输入名称" class="st-input-w"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <vxe-table
                ...
                <vxe-table-column field="title" title="自定义页面名称" min-width="100"></vxe-table-column>
                ...
                <vxe-table-column field="language" title="语言" min-width="50"><template v-slot:default="{ row }">{{languageText[row.language]}}</template>
                </vxe-table-column>
...
<script>
    import api from '@/api/cms/selfDefined';
