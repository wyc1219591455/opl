<template>
    <div class="app-container">
        <basic-container>
            ...
            <addPage path="/matchProductAdd"></addPage> 
            <!--表格部分-->
            <vxe-table
                    highlight-hover-row
                    resizable
                ...
                <vxe-table-column field="name" title="产品名称" min-width="100" tree-node></vxe-table-column>
                <vxe-table-column field="summary" title="产品描述" min-width="100"></vxe-table-column>
                <vxe-table-column field="language" title="所属分类" min-width="50">
                    <template v-slot:default="{ row }">{{ row.matchProductCategory&&row.matchProductCategory.name }}</template>
                </vxe-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getArticleCategoryList(){
                ...
                api.queryMatchProductList(params,'get').then((res) => {
