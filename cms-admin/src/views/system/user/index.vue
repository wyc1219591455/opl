                ...
                <el-col :xs="15" :sm="18" :md="19" :lg="20" :xl="20">
                    ...
                    <el-form ref="form" :inline="true" :model="form" :rules="rules" size="small" label-width="66px">
                        ...
                        <el-form-item label="邮箱" prop="email">
                            <el-input v-model="form.email" @blur="emailBlur" />
                        </el-form-item>
                        ...
                        <el-form-item label="岗位" prop="jobDatas">
                        <el-select
...
<script>
    ...
    export default {
        ...
        methods: {
            changeVal() {
                this.$refs.form.validateField('dept.id');
            },
            changeRole(value) {
                userRoles = []
            ...
            [CRUD.HOOK.beforeToEdit](crud, form) {
                ...
                form.roles.forEach(function (role) {
                    // roles.push(role.id)
                    console.log(_this.roleDatas)
                    _this.form.roleDatas.push(role.id)
                    // 初始化编辑时候的角色
                    const rol = {id: role.id}
                    userRoles.push(rol)
                })
                form.jobs.forEach(function (job) {
                    // jobs.push(job.id)
                    _this.form.jobDatas.push(job.id)
                    // 初始化编辑时候的岗位
            ...
            [CRUD.HOOK.afterValidateCU](crud) {
                if (!crud.form.dept.id) {
                    ...
                    return false
                } else if (this.form.jobDatas.length === 0) {
                    this.$message({
                        message: '岗位不能为空',
                        type: 'warning'
                    })
