    ...
    <basic-container>
      ...
      <div class="head-container">
        <div v-if="crud.props.searchToggle">
          <!-- 搜索 -->
          <el-input v-model="query.blurry" clearable size="small" placeholder="请输入菜单标题" style="width: 200px;" class="filter-item" @keyup.enter.native="toQuery" />
          <el-date-picker
        ...
        <el-form ref="form" :inline="true" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item v-show="form.type.toString() !== '2'" label="菜单图标" prop="icon">
            <el-popover
                    ...
                    width="450"
                    trigger="click"
                    @show="$refs['iconChoose'].reset()"
            >
              <IconChoose ref="iconChoose" @selected="selected" />
      ...
      >
        ...
        <el-table-column prop="icon" label="图标" align="center" width="60px">
          <template slot-scope="scope">
            ...
            <i class="iconfont font" :class="scope.row.icon ? scope.row.icon : ''" ></i>
          </template>
        </el-table-column>
...
// crud交由presenter持有
const defaultForm = { id: null, title: null, menuSort: 1, path: null, component: null, componentName: null, iframe: false, roles: [], pid: 0, icon: null, cache: false, hidden: false, type: 1, permission: null }
export default {
  name: 'Menu',
  components: { Treeselect, IconChoose, crudOperation, rrOperation, udOperation},
  cruds() {
