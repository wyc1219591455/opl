    ...
    <basic-container>
      ...
      <div class="head-container">
        <div v-if="crud.props.searchToggle">
          <!-- 搜索 -->
          <el-input v-model="query.name" clearable size="small" placeholder="输入部门名称" style="width: 200px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
          <el-date-picker
...
const defaultForm = { id: null, name: null, isTop: '1', subCount: 0, pid: null, deptSort: 1, enabled: 'true' }
export default {
  name: 'Dept',
